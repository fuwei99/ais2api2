...
class ConnectionManager extends EventTarget {
  ...
  constructor(endpoint = "ws://127.0.0.1:9998") {
    ...
    const injected = window.__PROXY_CONFIG__ || {};
    
    this.port = injected.wsPort || params.get("wsPort") || 9998;
    this.instanceId = injected.instanceId || params.get("instanceId") || "1";
  ...
  async establish() {
    ...
    Logger.output("正在连接到服务器:", this.wsUrl);
